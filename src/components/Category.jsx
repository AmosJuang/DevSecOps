    ...
    const categories = [
        {
            ...
            items: [
                { name: "The White Lotus", image: "/images/1.jpg", rating: 8.5 },
                { name: "Zero Day", image: "/images/2.jpg", rating: 7.9 },
                { name: "Severance", image: "/images/3.jpg", rating: 9.1 },
                { name: "Reacher", image: "/images/4.jpg", rating: 8.3 },
                { name: "Panic", image: "/images/5.jpg", rating: 7.7 },
                { name: "Reacher", image: "/images/6.jpg", rating: 8.3 },
                { name: "The White Lotus", image: "/images/7.jpg", rating: 8.5 },
                { name: "Zero Day", image: "/images/8.jpg", rating: 7.9 },
                { name: "Severance", image: "/images/9.jpg", rating: 9.1 },
                { name: "Panic", image: "/images/10.jpg", rating: 7.7 },
            ],
        },
        {
            title: "Fan favorites",
            items: [
                { name: "Amélie", image: "/images/1.jpg", rating: 8.9 },
                { name: "The Brutalist", image: "/images/2.jpg", rating: 7.5 },
                { name: "Daredevil: Born Again", image: "/images/3.jpg", rating: 8.7 },
                { name: "Companion", image: "/images/4.jpg", rating: 7.8 },
                { name: "Reacher", image: "/images/5.jpg", rating: 8.3 },
                { name: "The White Lotus", image: "/images/6.jpg", rating: 8.5 },
                { name: "Zero Day", image: "/images/7.jpg", rating: 7.9 },
                { name: "Severance", image: "/images/8.jpg", rating: 9.1 },
                { name: "Panic", image: "/images/9.jpg", rating: 7.7 },
                { name: "Reacher", image: "/images/10.jpg", rating: 8.3 },
            ],
        },
        {
            title: "Popular interests",
            items: [
                { name: "Superhero", image: "/images/1.jpg", rating: 8.2 },
                { name: "Coming-of-age", image: "/images/2.jpg", rating: 7.6 },
                { name: "Slasher Horror", image: "/images/3.jpg", rating: 7.3 },
                { name: "Reacher", image: "/images/4.jpg", rating: 8.3 },
                { name: "The White Lotus", image: "/images/5.jpg", rating: 8.5 },
                { name: "Zero Day", image: "/images/6.jpg", rating: 7.9 },
                { name: "Severance", image: "/images/7.jpg", rating: 9.1 },
                { name: "Panic", image: "/images/8.jpg", rating: 7.7 },
                { name: "Reacher", image: "/images/9.jpg", rating: 8.3 },
                { name: "The White Lotus", image: "/images/10.jpg", rating: 8.5 },
            ],
        },
    ];
